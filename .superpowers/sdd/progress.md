...
Task Production 2 historical-replay checkpoint: the identity-based replay path passed three independent review rounds and was committed at 6a807ee. Controller verification is 526 content tests passed with Ruff and diff checks clean. The real current 11-exchange set contained 3743 reviewed rows and 804 positive identities; 802 classifications were applied, 1 existing same-scene classification was left unchanged, and 1 dedupe rejection was skipped without resurrection. Old item IDs were not reused. Quota-aware read-only capacity is now 27625/30000 with shortage 2375; selected stage remains untouched at 0. Technology devices is now full. Remaining work is scene-specific reviewed exclusions, bounded residual semantic/LLM review, exact selection, translation, variants, and release review.
