...
SCENE_KEYWORDS = {
    ...
    "travel_hotel": ("hotel", "motel", "hostel", "reservation", "booking", "suite"),
    ...
    "study_exams": ("exam", "examination", "quiz", "revision", "grade", "test score"),
    ...
    "news_business": ("bank", "economy", "stocks", "finance", "profit", "tax"),
